...
class AuthService:
    def create_hashed_password_and_salt(self, *, plain_password: str) -> UserPasswordUpdate:
    ...
    def create_access_token(
        ...
        *,
        ...
        jwt_meta = JWTMeta(
            ...
            token_expires_in=datetime.timestamp(datetime.utcnow() + timedelta(seconds=expires_in)),
        )
    ...
    def decodeJWT(token: str) -> dict:
        try:
            ...
            return (
                decoded_token
                if decoded_token.get("token_expires_in") >= datetime.timestamp(datetime.utcnow())
                else None
            )
